...
predicted_df.to_csv('predicted_windspeed_2024.csv', index=False)

print("Parashikimi për vitin 2024 u ruajt me sukses në 'predicted_windspeed_2024.csv'")
...
plt.title('Krahasimi i Wind Speed - Të dhënat origjinale vs. Parashikimi 2024')
