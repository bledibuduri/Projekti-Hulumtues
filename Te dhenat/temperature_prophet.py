...
plt.plot(df['ds'], df['y'], label='Temperature')
...
future_predictions.rename(columns={'ds': 'Timestamp', 'yhat': 'Temperature'}, inplace=True)

# Print the first few rows of the predictions DataFrame to verify
print(future_predictions.head())

# Save the predictions to a CSV file
output_path = 'Temperature_predictions_prophet2024.csv'
