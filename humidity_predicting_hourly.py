...
predicted_df.to_csv('predicted_humidity_2024_hourly.csv', index=False)

print("Parashikimi për vitin 2024 u ruajt me sukses në 'predicted_humidity_2024_hourly.csv'")
...
plt.title('Krahasimi i lagështirës - Të dhënat origjinale vs. Parashikimi 2024 (Secila Orë)')
plt.xlabel('Timestamp (Data dhe Ora)')
plt.ylabel('Lagështira (%)')
plt.legend()
